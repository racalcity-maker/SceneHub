                                                     ...
                                                     const char *action_id)
{
    ...
    if (err == ESP_ERR_NOT_FOUND) {
        ...
        // Keep invalid arg as-is for caller and diagnostics.
    } else {
