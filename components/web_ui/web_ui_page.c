...
"h3,h4{margin:0 0 10px;color:#f0f2f5;font-weight:600;}"
        ...
        ".gm-entry{height:42px;padding:0 16px;border-radius:10px;background:#16a34a;color:#fff;text-decoration:none;font-weight:700;display:inline-flex;align-items:center;justify-content:center;box-shadow:0 6px 18px rgba(22,163,74,0.28);}"
        ".gm-entry:hover{background:#15803d;}"
